...
async fn main() {
    ...
    match cli.command {
        ...
        Commands::CheckMembership {
            ...
            // let input_3 = m3;
            // let input_4 = m4;
            // let a = FheUint32::encrypt(input_1, &client_key);
            // let b = FheUint32::encrypt(input_2, &client_key);
            // let c = FheUint32::encrypt(input_3, &client_key);
            // let d = FheUint32::encrypt(input_4, &client_key);
            ...
            let inputs = ContractInput {
                ...
                identity: blob_tx.identity.clone(),
                tx_hash: blob_tx_hash.clone(),
                private_input: vec![m1.to_le_bytes(), m2.to_le_bytes(), m3.to_le_bytes(), m4.to_le_bytes()].concat(),
                tx_ctx: None,
                blobs: blobs.clone(),
                index: sdk::BlobIndex(0),
            };
